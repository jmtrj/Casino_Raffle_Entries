...
if(isset($_GET['year']) && isset($_GET['month'])   ){
  ...
  $month = date('m');
    ...
    $stmt = $conn->prepare("SELECT Prize, COUNT(*) as NumWinners FROM tblwinner  JOIN tblplayer  ON tblwinner.PlayerId = tblplayer.Id  WHERE YEAR(Dateofspin) = ? and MONTH(Dateofspin) = ? GROUP BY Prize");
